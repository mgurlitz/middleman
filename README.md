...
A local-first pull request dashboard for project maintainers. Syncs provider data from your repos into SQLite, serves a fast Svelte 5 frontend from a single binary, and keeps you out of each provider's notification inbox.
